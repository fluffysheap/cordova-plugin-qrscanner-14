...
**This fork contains updates for make compatible to Gradle 7 and fixes to the original, now abandoned repo**
## Examples
...
```bash
cordova plugin add https://github.com/richmoh/cordova-plugin-qrscanner-13.git
```
